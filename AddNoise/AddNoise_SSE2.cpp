...
void updateFrame_sse2(const void *_srcp, void *_dstp, const int width,
...
template void updateFrame_sse2<uint8_t, int8_t>(
    const void *_srcp, void *_dstp, const int width, const int height,
    const ptrdiff_t stride, const int noisePlane, void *_pNW,
    const AddNoiseData *const VS_RESTRICT d) noexcept;
template void updateFrame_sse2<uint16_t, int16_t>(
    const void *_srcp, void *_dstp, const int width, const int height,
    const ptrdiff_t stride, const int noisePlane, void *_pNW,
    const AddNoiseData *const VS_RESTRICT d) noexcept;
template void updateFrame_sse2<float, float>(
    const void *_srcp, void *_dstp, const int width, const int height,
    const ptrdiff_t stride, const int noisePlane, void *_pNW,
    const AddNoiseData *const VS_RESTRICT d) noexcept;
#endif
